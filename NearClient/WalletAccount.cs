...
namespace NearClient
{
    public class WalletAccount
    {
        ...
        public WalletAccount(Near near, string appKeyPrefix, IExternalAuthService authService, IExternalAuthStorage authStorage)
        {
            ...
            appKeyPrefix =  string.IsNullOrWhiteSpace(appKeyPrefix)
                ? "default"
                : appKeyPrefix;
            _authDataKey = appKeyPrefix;
        ...
        public async Task MoveKeyFromTempToPermanent(string accountId, string publicKey)
        {
