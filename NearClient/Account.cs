...
namespace NearClient
{
    public class Account
    {
        ...
        public async Task<FinalExecutionOutcome> CreateAccountEmptyAsync(string newAccountId, string publicKey)
        {
            var accessKey = AccessKey.FullAccessKey();
            var actions = new[]
        ...
        public async Task<dynamic> GetValidatorAsync()
        {
            var result = await _connection.Provider.GetValidatorsStatusAsync();
            return result;
        }
        ...
        public async Task<dynamic> GetAccountChangesAsync()
        {
            return await _connection.Provider.GetAccountChangesAcync(_accountId);
        }
    }
}